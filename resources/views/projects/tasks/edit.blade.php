<x-app-layout>
    ...
    <div class="container py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center min-h-[10vh]">
            <h1 class="text-2xl font-bold">Taak bewerken</h1>
        </div>
            ...
            <div class="w-full md:w-3/4">
                <div class="overflow-x-auto bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <x-task-form action="{{ route('dashboard.projects.tasks.update', [$task->project->id, $task->id]) }}"
                            :states="$states" :users="$users" :task="$task"></x-project-form>
                    </div>
                </div>
            </div>
        </div>
